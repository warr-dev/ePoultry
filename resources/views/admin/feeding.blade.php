    ...
    <div class="modal-dialog">
      <div class="modal-content">
                    ...
                    <div class="col-md-12 stretch-card">
                        <div class="d-flex justify-content-between w-100">
                            @foreach ($days as $ind=>$day)
                                <input type="checkbox" name="days[]" value="{{$ind}}" id="{{$day}}"><label for="{{$day}}">{{$day}}</label>
                            @endforeach
                        </div>
                    </div>
                    <div class="col-md-12 stretch-card">
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="$('#form-addtime').submit()" class="btn btn-primary">Save changes</button>
        </div>
      </div>
    </div>
  </div>
